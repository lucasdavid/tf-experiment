...
# ==============================================================================
#
# Train ResNet50 to perform multilabel classification task over Cifar10.
#
...
#   EXPERIMENT_TAGS="['coco17', 'rn50', 'momentum']"
#   LOGS=./logs/classification/coco17/train.rn50.noaug
#
