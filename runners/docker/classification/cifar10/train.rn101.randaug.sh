...
# ==============================================================================
#
# Train ResNet101 to perform multiclass classification task over Cifar10.
#
...
#
#   EXPERIMENT=rn101-noaug
#   EXPERIMENT_TAGS="['cifar10', 'rn101', 'momentum']"
#   LOGS=./logs/classification/cifar10/train.rn101.noaug
#
...
EXPERIMENT_TAGS="['cifar10', 'rn101', 'momentum', 'randaug']"

SOURCE=src/train_and_finetune.py
LOGS=./logs/classification/cifar10/train.rn101.randaug
