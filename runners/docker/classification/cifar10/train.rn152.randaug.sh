...
# ==============================================================================
#
# Train ResNet152 to perform multiclass classification task over Cifar10.
#
...
#
#   EXPERIMENT=rn152-noaug
#   EXPERIMENT_TAGS="['cifar10', 'rn152', 'momentum']"
#   LOGS=./logs/classification/cifar10/train.rn152.noaug
#
...
EXPERIMENT=rn152-randaug
EXPERIMENT_TAGS="['cifar10', 'rn152', 'momentum', 'randaug']"

SOURCE=src/train_and_finetune.py
LOGS=./logs/classification/cifar10/train.rn152.randaug
